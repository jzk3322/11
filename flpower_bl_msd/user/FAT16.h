...
#define FAT_EVENT_IDLE          0x0000
#define FAT_EVENT_READY         0x0001
#define FAT_EVENT_SUCCESS       0x0002
#define FAT_EVENT_UNKOWN        0x0004
#define FAT_EVENT_LARGE         0x0008
#define FAT_EVENT_ERRAPP        0x0010
...
extern fat_event_t fat_event;

extern void fat_event_set(uint16_t info);
extern uint32_t FATReadLBA(uint32_t FAT_LBA,uint8_t* data, uint32_t len);
extern uint32_t FATWriteLBA(uint32_t FAT_LBA,uint8_t* data, uint32_t len);

extern uint32_t FATSetStatusFileName(const char * name);
